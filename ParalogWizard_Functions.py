...
def get_plot(path: str, name: str, matrix: numpy.ndarray, mix: BayesianGaussianMixture, lines: Dict[str, float],
             num_contig, mode):
    matplotlib.use('Agg')
    ...
    colors: str = random.sample(['#FF0000', '#008000', '#0000FF', '#FF00FF', '#800000', '#808000', '#008080', '#2196F3',
    ...
    axis.hist(matrix, bins=numpy.arange(0, max_of_matrix, 1),
